 ...
 */
public class ReclamoPreguntaTest {
    ...
    public static void setUpClass() throws InterruptedException {
        try {
            ...
            Thread.sleep(2000);
            outputFile = Configuration.fileCfg("Reclamo-Pregunta", LOGGER);
    ...
    public void Reclamo() throws InterruptedException, IOException{
        ...
        String id = crearReclamoPage.crearReclamoAction(driver, LOGGER, Datos.rut, "PREGUNTA", "PREGUNTA", "FELICITACIONES", outputFile.getAbsolutePath());

        //gestorReclamosPage.buscarReclamoAction(driver, LOGGER, id, outputFile.getAbsolutePath());

        //crearReclamoPage.cerrarReclamoAction(driver, LOGGER, Datos.rut, "PREGUNTA", "EXPLICACION A CLIENTE", outputFile.getAbsolutePath(), id);
    }
}
