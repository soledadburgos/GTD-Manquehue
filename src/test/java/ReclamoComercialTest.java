 ...
 */
public class ReclamoComercialTest {
    ...
    public static void setUpClass() throws InterruptedException {
        try {
            ...
            Thread.sleep(2000);
            outputFile = Configuration.fileCfg("Reclamo-Comercial", LOGGER);
    ...
    public void Reclamo() throws InterruptedException, IOException{
        ...
        String id = crearReclamoPage.crearReclamoAction(driver, LOGGER, Datos.rut, "COMERCIAL", "ENVIOS", "NO RECIBIO CORRESPONDENCIA CIA", outputFile.getAbsolutePath());

        gestorReclamosPage.buscarReclamoAction(driver, LOGGER, id, outputFile.getAbsolutePath());

        crearReclamoPage.cerrarReclamoAction(driver, LOGGER, Datos.rut, "SERVICIOS", "SE ENVIA GUIA A DOMICILIO DE CLIENTE", outputFile.getAbsolutePath(), id);
    }
}
