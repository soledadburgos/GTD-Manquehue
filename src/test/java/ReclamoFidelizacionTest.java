 ...
 */
public class ReclamoFidelizacionTest {
    ...
    public ReclamoFidelizacionTest() {
    }
    ...
    public static void setUpClass() throws InterruptedException {
        try {
            ...
            Thread.sleep(2000);
            outputFile = Configuration.fileCfg("Reclamo-Fidelización", LOGGER);
    ...
    public void Reclamo() throws InterruptedException, IOException{
        ...
        String id = crearReclamoPage.crearReclamoAction(driver, LOGGER, Datos.rut, "FIDELIZACION", "FIDELIZACION", "FIDELIZACION_LLAMADO DE BIENVENIDA", outputFile.getAbsolutePath());
        //String id = "6134834";
        gestorReclamosPage.buscarReclamoAction(driver, LOGGER, id, outputFile.getAbsolutePath());

        crearReclamoPage.cerrarReclamoAction(driver, LOGGER, Datos.rut, "FIDELIZACION", "CLIENTE CONFORME", outputFile.getAbsolutePath(), id);
    }
}
