 ...
 */
public class ReclamoFacturacionTest {
    ...
    public static void setUpClass() throws InterruptedException {
        try {
            ...
            Thread.sleep(2000);
            outputFile = Configuration.fileCfg("Reclamo-Facturación", LOGGER);
    ...
    public void Reclamo() throws InterruptedException, IOException{
        ...
        String id = crearReclamoPage.crearReclamoAction(driver, LOGGER, Datos.rut, "FACTURACION", "FACTURACION", "LLAMADA NO RECONOCIDA", outputFile.getAbsolutePath());
        //String id = "6134826";
        gestorReclamosPage.buscarReclamoAction(driver, LOGGER, id, outputFile.getAbsolutePath());

        crearReclamoPage.cerrarReclamoAction(driver, LOGGER, Datos.rut, "FACTURACION", "SE AJUSTA CARGO", outputFile.getAbsolutePath(), id);
    }
}
